...
export class Migration1754151249066 implements MigrationInterface {
    name = 'Migration1754151249066'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."project_task_status_enum" AS ENUM('TODO', 'IN_PROGRESS', 'COMPLETED', 'BLOCKED', 'ON_HOLD', 'CANCELLED')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TYPE "public"."project_task_status_enum"`);
    }
